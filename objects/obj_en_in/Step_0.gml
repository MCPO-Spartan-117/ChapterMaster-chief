...
if (cooldown1 > 0) { cooldown1 -= 1 * global.frame_pacing; }
...
if (instance_exists(target)){
    ...
    if (action="close"){speed = 4 * global.frame_pacing; direction = turn_towards_point(direction, x, y, target.x, target.y, 6);}
    ...
    if (action="shoot") and (cooldown1<=0){
        var bull; cooldown1 = 30 * global.frame_pacing; if (owner = eFACTION.Tau) { cooldown1 = 20 * global.frame_pacing; }
        ...
        bull.speed = 20 * global.frame_pacing; bull.image_xscale = 0.5; bull.image_yscale = 0.5; bull.dam = 3;
